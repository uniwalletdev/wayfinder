...
const SECTIONS: { heading: string; items: { href: string; label: string; Icon: typeof Activity }[] }[] = [
  {
    heading: "Overview",
    items: [{ href: "/backoffice", label: "Dashboard", Icon: LayoutDashboard }],
  },
  {
    heading: "The map",
    items: [
      { href: "/backoffice/venues", label: "Shared venues", Icon: Building2 },
      { href: "/backoffice/catalog", label: "Venue catalogue", Icon: Map },
    ],
  },
  {
    heading: "What people do",
    items: [
      { href: "/backoffice/demand", label: "Unmet searches", Icon: Search },
      { href: "/backoffice/activity", label: "Navigation activity", Icon: Activity },
    ],
  },
  {
    heading: "Governance",
    items: [
      { href: "/backoffice/privacy", label: "Data & retention", Icon: ShieldCheck },
      { href: "/backoffice/audit", label: "Audit log", Icon: ScrollText },
      { href: "/backoffice/settings", label: "Settings & health", Icon: Settings },
    ],
  },
]
