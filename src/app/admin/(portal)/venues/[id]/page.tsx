...
import WaypointsPanel from "@/components/admin/WaypointsPanel"
import { humanise, resolutionLabel } from "@/components/admin/labels"
import {
  Badge,
  Card,
  Notice,
...
import { getVenueDetail } from "@/lib/admin/data"
    ...
    <>
      ...
      <section className="mb-6 grid items-start gap-5 lg:grid-cols-2">
        ...
        <Card
          ...
          bodyClassName=""
          actions={
            <Link href={`/admin/demand?venueKey=${venue.id}`} className="text-[12.5px] font-semibold text-wf-primary">
              Manage →
            </Link>
          }
        >
