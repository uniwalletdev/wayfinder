...
import { statusBadge, visibilityLabel } from "@/components/admin/labels"
import { QuickStatusButton } from "@/components/admin/VenueActions"
import {
  Badge,
  Card,
  EmptyState,
...
import { listVenues, type VenueSort } from "@/lib/admin/data"
...
export default async function VenuesPage({
  ...
  return (
    <>
      ...
      <FilterForm action="/admin/venues" className="mb-5 flex flex-wrap items-center gap-2.5">
        <input
          type="search"
          name="q"
          defaultValue={q}
        ...
        <Link href="/admin/venues" className="px-1 text-[12.5px] font-semibold text-wf-muted hover:text-wf-primary">
          Reset
        </Link>
      </FilterForm>
