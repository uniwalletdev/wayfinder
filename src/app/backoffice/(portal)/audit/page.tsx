...
import { humanise } from "@/components/backoffice/labels"
import {
  Badge,
  BTN_QUIET,
  Card,
...
import { isUuid, listAudit } from "@/lib/backoffice/data"
  ...
  return (
    <>
      ...
      {!result.ok ? (
        ...
        <>
          <FilterForm action="/backoffice/audit" className="mb-5 flex flex-wrap items-center gap-2.5">
            <input
              type="search"
              name="q"
              defaultValue={q}
            ...
            <Link href="/backoffice/audit" className="px-1 text-[12.5px] font-semibold text-wf-muted hover:text-wf-primary">
              Reset
            </Link>
          </FilterForm>
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="mt-1 text-[12px] text-wf-faint">
                            ...
                            {venueId && isUuid(venueId) ? (
                              <>
                                {" · "}
                                <Link href={`/backoffice/venues/${venueId}`} className="font-semibold text-wf-primary hover:underline">
                                  open the venue
                                </Link>
                              </>
                            ) : null}
