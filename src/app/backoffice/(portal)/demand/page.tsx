...
import { ReopenDemand, ResolveDemand } from "@/components/backoffice/DemandActions"
import { FilterForm } from "@/components/backoffice/forms"
import { resolutionLabel } from "@/components/backoffice/labels"
import {
  Badge,
  BTN_QUIET,
  Card,
...
import { listDemand } from "@/lib/backoffice/data"
...
export default async function DemandPage({
  ...
  return (
    <>
      ...
      <FilterForm action="/backoffice/demand" className="mb-5 flex flex-wrap items-center gap-2.5">
        ...
        <Link href="/backoffice/demand" className="px-1 text-[12.5px] font-semibold text-wf-muted hover:text-wf-primary">
          Reset
        </Link>
      </FilterForm>
        ...
        <div className="mb-5">
          <Notice tone="info" title="Filtered to one venue">
            <p>
              ...
              <Link href="/backoffice/demand" className="underline">
                Show every venue
              </Link>
              .
            </p>
      ...
      <div className="mt-6">
        <Notice tone="info" title="Where these come from">
          <p>
            ...
            <Link href="/backoffice/privacy" className="underline">
