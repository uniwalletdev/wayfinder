...
import { COVERAGE_SHADES, ShareBar } from "@/components/backoffice/charts"
import { FilterForm } from "@/components/backoffice/forms"
import { tierLabel } from "@/components/backoffice/labels"
import {
  Badge,
  BTN_QUIET,
  Card,
...
import { catalogSummary, queryCatalog, type CoverageTier } from "@/lib/backoffice/catalog"
...
export default async function CatalogPage({
  ...
  return (
    <>
      ...
      <FilterForm action="/backoffice/catalog" className="mb-5 flex flex-wrap items-center gap-2.5">
        <input
          type="search"
          name="q"
          defaultValue={q}
        ...
        <Link href="/backoffice/catalog" className="px-1 text-[12.5px] font-semibold text-wf-muted hover:text-wf-primary">
          Reset
        </Link>
      </FilterForm>
