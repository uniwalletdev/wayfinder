...
import { EraseDeviceForm, PurgeForm } from "@/components/backoffice/RetentionForms"
import {
  BTN_QUIET,
  Card,
  INPUT,
...
import { getDeviceRecord, getRetentionStats } from "@/lib/backoffice/data"
      ...
      {!stats.ok ? (
        ...
        <>
          ...
          >
            ...
            <FilterForm action="/backoffice/privacy" className="flex flex-wrap items-end gap-2.5">
              ...
              {device ? (
                <Link href="/backoffice/privacy" className="px-1 pb-3 text-[12.5px] font-semibold text-wf-muted hover:text-wf-primary">
                  Clear
                </Link>
              ) : null}
            </FilterForm>
              ...
              <div className="mt-5">
                <Notice tone="good" title="Nothing is held for that identifier">
                  <p>
                    ...
                    <Link href="/backoffice/audit?action=retention.erase_device" className="underline">
                      audit log
                    </Link>
                    .
                  </p>
